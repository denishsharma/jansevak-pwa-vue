<template>
    <ModalPage id="about-platform" ref="refModalPage">
        <AppContainerBase>
            <template #title>About Jansevak</template>
            ...
            <template #body>
                <PageHeading class="mb-6" emphasis="Jansevak" title="About">
                    <template #subtitle>
                        Know more about Jansevak and how it works. Know more about the people behind this
                    </template>
                </PageHeading>

                <AppComponentBase>
                    <div>
                        Jansevak is a platform for the people of India to connect with their representatives and get
