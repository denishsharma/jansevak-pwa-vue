                    ...
                    <div class="flex flex-col gap-5">
                        <div class="flex justify-center items-center">
                            <div class="h-[8rem] w-[8rem] relative">
                                <img alt="" class="rounded-full h-full w-full object-cover object-center overflow-hidden" src="https://api.dicebear.com/5.x/thumbs/svg?seed=Denish">

                                <button class="absolute z-10 right-0 bottom-0 h-9 w-9 mr-0.5 mb-0.5 inline-flex flex-shrink-0 justify-center items-center gap-2 shadow-[0_2px_10px_0_rgba(0,0,0,0.08)] rounded-full border border-gray-100 bg-white text-gray-600 hover:bg-gray-100 active:bg-gray-200 focus:outline-none transition-all" type="button">
                        ...
                        <div class="grid grid-cols-2 gap-x-3 mt-3">
                            <div class="flex flex-col">
                                ...
                                <label class="relative">
                                    <input class="py-3 px-4 block w-full border-gray-200/[0.7] rounded-lg text-sm focus:z-10 focus:border-orange-500 focus:ring-orange-500" name="firstname" placeholder="e.g. Denish" type="text">
                                </label>
                            </div>
                            ...
                            <div class="flex flex-col">
                                ...
                                <label class="relative">
                                    <input class="py-3 px-4 block w-full border-gray-200/[0.7] rounded-lg text-sm focus:z-10 focus:border-orange-500 focus:ring-orange-500" name="lastname" placeholder="e.g. Sharma" type="text">
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <label class="select-none flex px-4 py-3 block w-full bg-white border border-gray-200/[0.7] rounded-lg text-sm focus:border-orange-500 focus:ring-orange-500">
                                        <input checked class="shrink-0 mt-0.5 border-gray-200 rounded-full text-orange-500 pointer-events-none focus:ring-orange-500" name="gender" type="radio">
                                        <span class="text-sm font-medium ml-3.5">Male</span>
                                    </label>

                                    <label class="select-none flex px-4 py-3 block w-full bg-white border border-gray-200/[0.7] rounded-lg text-sm focus:border-orange-500 focus:ring-orange-500">
                                        <input class="shrink-0 mt-0.5 border-gray-200 rounded-full text-orange-500 pointer-events-none focus:ring-orange-500" name="gender" type="radio">
                        ...
                        <div class="grid grid-cols-1 gap-x-3">
                            <div class="flex flex-col">
                                ...
                                <label class="relative">
                                    <input class="py-3 px-4 block w-full border-gray-200/[0.7] rounded-lg text-sm focus:z-10 focus:border-orange-500 focus:ring-orange-500" placeholder="Enter your email address" type="text">
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-x-3">
                            <div class="flex flex-col">
                                ...
                                <label class="relative">
                                    <input class="py-3 px-4 block w-full border-gray-200/[0.7] rounded-lg text-sm focus:z-10 focus:border-orange-500 focus:ring-orange-500" placeholder="e.g. G-1, Sandhya Building, Dharmajaya CHS" type="text">
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-x-3">
                            <div class="flex flex-col">
                                ...
                                <label class="relative">
                                    <input class="py-3 px-4 block w-full border-gray-200/[0.7] rounded-lg text-sm focus:z-10 focus:border-orange-500 focus:ring-orange-500" placeholder="e.g. Vidyaben Gardi School" type="text">
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-x-3">
                            <div class="flex flex-col">
                                ...
                                <label class="relative">
                                    <input class="py-3 px-4 block w-full border-gray-200/[0.7] rounded-lg text-sm focus:z-10 focus:border-orange-500 focus:ring-orange-500" placeholder="e.g. 400080" type="text">
                                </label>
                    ...
                    <div class="flex flex-col gap-5 mt-4">
                        <div class="grid grid-cols-1 gap-x-3">
                            <div class="flex flex-col">
                                ...
                                <label class="relative">
                                    <input class="py-3 px-4 block w-full border-gray-200/[0.7] rounded-lg text-sm focus:z-10 focus:border-orange-500 focus:ring-orange-500" placeholder="e.g. T-Ward" type="text">
                                </label>
                                <div class="block text-xxs leading-tight text-gray-300 font-medium mt-1.5">
                        ...
                        <div class="grid grid-cols-1 gap-x-3">
                            <div class="flex flex-col">
                                ...
                                <label class="relative">
                                    <input v-maska class="py-3 px-4 block w-full border-gray-200/[0.7] rounded-lg text-sm focus:z-10 focus:border-orange-500 focus:ring-orange-500" data-maska="#### #### ####" placeholder="e.g. 0000 0000 0000" type="text">
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-x-3">
                            <div class="flex flex-col">
                                ...
                                <label class="relative">
                                    <input v-maska class="py-3 px-4 block w-full border-gray-200/[0.7] rounded-lg text-sm uppercase focus:z-10 focus:border-orange-500 focus:ring-orange-500" data-maska="@@@#######" placeholder="e.g. ABC1234567" type="text">
                                </label>
                            </div>
                        </div>
                    </div>
