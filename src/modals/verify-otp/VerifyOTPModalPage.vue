...
const closeModal = () => {
    isOpen.value = false;
    window.history.replaceState({}, "", router.currentRoute.value.fullPath.replace("/#verify-otp", ""));
    window.removeEventListener("popstate", closeModal);
};

const openModal = () => {
    isOpen.value = true;
    window.history.pushState({}, "", router.currentRoute.value.fullPath.replace("/#verify-otp", "") + "/#verify-otp");
    nextTick(() => {
