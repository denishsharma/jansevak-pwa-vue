                    ...
                    <div v-for="query in myQueries" :key="query.uuid" class="bg-white select-none flex flex-col divide-y divide-gray-200 overflow-y-hidden rounded-lg border border-gray-200 shadow-[0_2px_6px_0_rgba(0,0,0,0.02)]">
                        <div class="px-3.5 py-2 flex flex-col gap-2">
                            <div class="flex items-center justify-between gap-4">
                                <button class="text-gray-600 px-1 py-0.5 -my-0.5 -mx-1 transition hover:bg-gray-100 active:bg-gray-200 rounded-full flex items-center gap-1.5 font-medium text-xxs">
                                    <div class="h-3 w-3">
                                ...
                                <div class="text-gray-400 flex items-center gap-1 font-medium text-xxs">
                                    <div>
                                        {{ user.id === query.onBehalfOf.uuid ? "Myself" : query.onBehalfOf.fullName }}
                                    </div>
                        ...
                        <button class="px-3.5 py-2 text-xs gap-2 inline-flex text-gray-500 items-center font-medium text-left active:bg-gray-100 focus:outline-none transition" @click="openQueryDetailModal">
